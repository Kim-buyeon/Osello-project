...
public class OthelloGame extends TwoDGame {
	...
	public void addGameRecord(boolean isWin, int playerScore, int computerScore) {
        GameRecord record = new GameRecord(aiLevel, isWin, playerScore, computerScore);
        LevelSelector.addGameRecord(record);
    }
